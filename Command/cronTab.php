...
$firstCronJob = "*/2 * * * * $executionFile {$commandDir}redisCache.php";
$secondCronJob = "*/3 * * * * $executionFile {$commandDir}daily_notification.php";
$thirdCronJob = "*/5 * * * * $executionFile {$commandDir}monthly_report.php";
